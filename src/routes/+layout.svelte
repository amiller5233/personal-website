	...
	<div class="flex items-center justify-between flxe-wrap max-w-screen-xl mx-4 xl:mx-auto py-6">
		...
		<div class="flex items-center justify-between w-auto">
			<ul class="flex items-center p-0 space-x-8">
				<li>
					<a href="/" class="text-emphasis font-display uppercase leading-none py-2 hover:text-chromatic">Home</a>
				</li>
				<li>
					<a href="/portfolio" class="text-emphasis font-display uppercase leading-none py-2 hover:text-chromatic">Portfolio</a>
				</li>
				<li>
...
<footer class="bg-body-secondary-bg py-10">
	<div class="mx-4 max-w-screen-lg lg:mx-auto">
		<div class="flex flex-col md:flex-row md:columns-2 gap-8">
			<div class="w-full">
				...
				<p class="text-lg text-emphasis font-display">Adam Miller</p>
				<p class="text-sm text-gray-500">copyright &copy; Adam Miller { currentYear }</p>
			</div>
			<div class="w-full">
				<p class="text-lg text-emphasis font-display mb-2">Socials</p>
				<a href="https://www.github.com/amiller5233" class="inline-block hover:text-cyan-500 me-2">
				...
				<a href="https://www.linkedin.com/in/adam-miller-3b2b71127/" class="inline-block hover:text-cyan-500 me-2">
