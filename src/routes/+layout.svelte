...
<nav class="fixed w-full z-20 top-0 start-0">
	<div class="flex items-center justify-between flxe-wrap max-w-screen-xl mx-4 xl:mx-auto py-8">
		...
		<div class="flex items-center justify-between w-auto">
			<ul class="flex p-0 space-x-8">
				<li>
					<a href="portfolio" class="text-gray-800 font-display uppercase">Portfolio</a>
				</li>
				<!-- <li>
...
<footer class="bg-gray-100 py-10">
	<div class="lg:container lg:mx-auto mx-4">
		<div class="flex flex-col md:flex-row md:columns-2">
			<div class="w-full">
				<img src="favicon.png" width="36" height="36" alt="Adam Miller icon" class="bg-white rounded-lg shadow mb-2">
				<p class="text-lg font-display">Adam Miller</p>
				<p class="text-sm text-gray-500">copyright &copy; Adam Miller { currentYear }</p>
			</div>
			<div class="w-full">
				<p class="text-lg font-display mb-2">Socials</p>
				<a href="https://www.github.com/amiller5233" class="inline-block hover:text-cyan-400 me-1">
				...
				<a href="https://www.linkedin.com/in/adam-miller-3b2b71127/" class="inline-block hover:text-cyan-400 me-1">
				...
				<a href="mailto:amiller5233@gmail.com?subject=Hi Adam, it's great to meet you!" class="inline-block hover:text-cyan-400 me-1">
