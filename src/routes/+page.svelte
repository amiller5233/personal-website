	...
	<div class="content-pane">
		<div class="flex flex-col md:flex-row items-center gap-6 mx-4">
			...
			<div class="text-start">
				...
				<p class="text-lg lg:text-2xl">who loves building websites with {#key currentStyle}<span in:fade="{{ duration: 300 }}" class="inline-block" style="height:36px; width:170px;">{@html currentStyle}</span>{/key}</p>
			</div>
		</div>
	</div>
...
<section>
	<div class="mx-4 max-w-screen-lg lg:mx-auto py-12">
		...
		<div class="flex flex-col md:flex-row md:columns-2 items-center gap-8">
			<div class="w-full">
				<p class="text-base mb-6">My humble beginning as a developer came in my junior year of high school, when I enrolled in AP CompSci with my best friend, fell in love with coding and never looked back.</p>

				<p class="text-base mb-6">At Santa Clara University, my roomates and I fully immersed outselves into learning about web devlopment. Countless hours were spent tinkering with everything from HTML canvas to social networks, and starting ambitious projects that never <i>quite</i> got off the ground.</p>

				<p class="text-base mb-6">Now, I work as a full-time full stack developer, and I love building new stuff every day. When I'm not working on a coding project, I love running, playing Nintendo games and crafting cocktails.</p>

				<p class="text-base mb-6">Oh, and that cookie that I promised above is available in DevTools, if you'd care to collect it 🍪</p>
			</div>
			<div class="w-full">
...
<section>
	<div class="mx-4 max-w-screen-lg lg:mx-auto py-12">
		...
		<p class="text-center text-lg mx-auto mb-12" style="max-width:700px;">I have learned a thousand skills across a thousand different lives... Actually, I just do a lot of random stuff. Here's my prized collections of odds and ends 🧙‍♂️</p>
