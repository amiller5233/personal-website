export const oldPortfolio = {
	"sundance-splash-page":{
		"name":"Sundance Transport Website",
		"desc_short":"I designed the company splash page for Sundance Transport",
		"desc_full":"I created, deployed, and currently maintain a responsive website for Sundance Transport, Inc. The website serves to inform customers about our services, and it generates dozens of leads per month. An design overhaul is currently under construction.",
		"cover_img":"sti/home.png",
	...
	"truck-routing-application":{
		...
		"date_end":"June 2020",
		"github_url": "https://github.com/amiller5233/truck-routing-application",
	...
	"ubridge-splash-page":{
		...
		"github_url": "https://github.com/amiller5233/ubridge-splash-dup",
		"tags":["website"]
	},
	"cost-projection-database":{
